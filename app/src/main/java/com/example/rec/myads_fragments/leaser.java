...
import com.example.rec.menu_fragments.chat_fragments.Users;
...
public class leaser extends Fragment implements RecyclerItemTouch.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren())
                {
                    ...
                    if(current_uid.equals(uidz) && type.equals("leaser"))
                    {
              ...
              /*  locationz = dataSnapshot.child("location").getValue().toString();
                areaz = dataSnapshot.child("area").getValue().toString();
                siteTypez = dataSnapshot.child("siteType").getValue().toString();
                areaz = dataSnapshot.child("area").getValue().toString();
                descriptionz = dataSnapshot.child("description").getValue().toString();*/
        ...
        for(int i=0;i<aanishbhai.size();i++)
        {
            productList.add(new product( iop,aanishbhai.get(i).getLocation(),
